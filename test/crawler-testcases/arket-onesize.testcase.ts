...
export const arketOneSizeTestCase = {
  ...
  name: 'Glazed Plate 19 cm',

  priceChecks: [
    { size: '0775166002001', price: 8 },
...
\t<meta http-equiv="Expires" content="-1">
    ...
    <title>Glazed Plate 19 cm - White/Brown - Kitchen - ARKET DE</title><meta name="description" content=" With a plain design, this small plate is made of stoneware and fully glazed. Diameter 19 cm "><meta http-equiv="content-type" content="text/html; charset=UTF-8">
    <meta name="keywords" content="Glazed Plate 19 cm">
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=yes">
<meta name="format-detection" content="telephone=no">
<meta property="og:title" content="Glazed Plate 19 cm - White/Brown - Kitchen - ARKET DE">
\t<meta property="og:description" content=" With a plain design, this small plate is made of stoneware and fully glazed. Diameter 19 cm ">
\t<meta property="og:url" content="https://www.arket.com/en_eur/homeware/kitchen/product.glazed-plate-19-cm-beige.0775166002.html">
\t<meta property="og:site_name" content="ARKET">
\t<meta property="og:type" content="product">
\t<meta property="og:image" content="https://lp.arket.com/app006prod%3Fset%3Dsource%5B02_0775166_002_1%5D%2Ctype%5BPRODUCT%5D%2Cdevice%5Bhdpi%5D%2Cquality%5B80%5D%2CImageVersion%5B201907291654%5D%26call%3Durl%5Bfile%3A%2Fproduct%2Fmain%5D">
...
\t<meta property="fb:app_id" content="138733209821465" >
 ...
 \t<script type="text/javascript" src="/dtagent_ICA23STVjpqrx_7000100211014.js" data-dtconfig="agentUri=/dtagent_ICA23STVjpqrx_7000100211014.js|rid=RID_1021513524|rpid=466737545|domain=arket.com|lastModification=1552954611127|lab=1|tp=500,50,0,1,10|reportUrl=dynaTraceMonitor|app=Appeaser Production Desktop Web"></script><script src="/etc/designs/appeaser/p11/clientlibs/pattern-lib/frontend/js/modernizr-custom.min.js"></script><style type="text/css"></style>
...
<link rel="shortcut icon" type="image/png" href="/etc/designs/appeaser/p11/favicons/favicon-32.png">
    ...
    <link rel="canonical" href="https://www.arket.com/en_eur/homeware/product.glazed-plate-19-cm-beige.0775166002.html"/>\t\t
\t<link rel="alternate" hreflang="en-GB" href="https://www.arket.com/en_gbp/homeware/product.glazed-plate-19-cm-beige.0775166002.html">
\t<link rel="alternate" hreflang="en-SE" href="https://www.arket.com/en_sek/homeware/product.glazed-plate-19-cm-beige.0775166002.html">
\t<link rel="alternate" hreflang="en-NO" href="https://www.arket.com/en_nok/homeware/product.glazed-plate-19-cm-beige.0775166002.html">
\t<link rel="alternate" hreflang="en-DK" href="https://www.arket.com/en_dkk/homeware/product.glazed-plate-19-cm-beige.0775166002.html">
\t<link rel="alternate" hreflang="x-default" href="https://www.arket.com/en_eur/homeware/product.glazed-plate-19-cm-beige.0775166002.html">
\t<script type="text/javascript" src="/en_eur/metrics/default/touchpoint.js"></script>
    ...
    <input type="hidden" id="metaPrice" value="8.0"/>\t\t\t\t
...
\t\t\t<ul class="departments">
        ...
        \t\t\t
        \t\t\t\t<li>
        \t\t\t\t\t<a href="/en_eur/men.html" target="_self" class="a-link department-item " data-title="Men">
        \t\t\t\t\t\tMen
        \t\t\t\t\t</a>
        \t\t\t\t</li>
        \t\t\t
        ...
        \t\t\t
        \t\t\t\t<li>
        \t\t\t\t\t<a href="/en_eur/homeware.html" target="_self" class="a-link department-item is-active" data-title="Homeware">
        \t\t\t\t\t\tHomeware
        \t\t\t\t\t</a>
        \t\t\t\t</li>
        \t\t\t
...
<input type="hidden" id="georguri" value="?goeorguri=%2Fen_eur%2Fhomeware%2Fkitchen%2Fproduct.glazed-plate-19-cm-beige.0775166002.html" />
...
<script type="text/javascript" src="/etc/designs/appeaser/p11/clientlibs/aem-clientlibs/selectCountryLightbox_Clientlib.min.js"></script>
    ...
    <script type="text/html" id="select-country-checkout"><div class="m-change-country-lightbox is-checkout"><h2 class="a-heading-2">Change location</h2><p class="a-paragraph">Your shopping bag will be moved to the selected location.</p><a class="a-button is-primary" href="/entrance.html?goeorguri=%2Fen_eur%2Fhomeware%2Fkitchen%2Fproduct.glazed-plate-19-cm-beige.0775166002.html">Continue</a><button class="a-button is-secondary js-close-button"><span>false</span></button></div></script>
...
<form data-component="OForm" class="o-form add-to-cart" action="/someURL" method="POST" onsubmit="p11App.productDet.trackAddToCart('en_eur', '0775166002', this)">
<div id="pdpDisplayDataStorage" data-locale="en_eur" data-article-ids="0775166002,0775166001" hidden></div>
<div id="fb-root"></div>
    <script>
        (function(d, s, id) {
...
<div id="pdpDetailsDataStorage" data-locale="en_eur" data-article-ids="0775166002,0775166001" hidden></div>
<script>
\tvar productArticleDetails = {
\t\t
\t\t'articleCode':'0775166002',
\t\t'baseProductCode' : '0775166_group_002',
\t\t'mainCategorySummary' : 'Kitchen - homeware_kitchen_all',
\t\t'name': 'Glazed Plate 19 cm',
\t\t'scentProduct': 'false',
\t\t
\t\t'styleWithArticles' : [
...
\t\t
\t\t\t'0775166002': {
\t\t\t\t'title': 'Glazed Plate 19 cm',
\t\t\t\t'name': 'White\\/Brown',
\t\t\t\t'colorCode': '14',
\t\t\t\t'description': '<div>With a plain design, this small plate is made of stoneware and fully glazed.<\\/div><ul><li>Diameter 19 cm<br><\\/li><\\/ul>',
\t\t\t\t'atelierName': "",
\t\t\t\t'brandName': "",
\t\t\t\t'colorLoc': "White/Brown",
\t\t\t\t'pdpLink' : 'https:\\/\\/www.arket.com\\/en_eur\\/homeware\\/kitchen\\/product.glazed-plate-19-cm-beige.0775166002.html',
...
\t\t\t\t\t\t\t{
\t\t\t\t\t\t\t\t'code':'0671713003',
\t\t\t\t\t\t\t\t'name': 'Serax Plate Merci No 3, Medium14 cm',
\t\t\t\t\t\t\t\t'url':'/en_eur/productpage.0671713003.html',
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t'imageUrl':'set=source[02_0671713_003_1],type[PRODUCT],ImageVersion[201908051103]&call=url[file:/product/dynamic.chain]',
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t'price': '€10',
\t\t\t\t\t\t\t\t\t\t'priceOriginal': false,
\t\t\t\t\t\t\t\t\t\t'priceValue': '10.0',
...
\t\t\t\t\t\t\t{
\t\t\t\t\t\t\t\t'code':'0671850004',
\t\t\t\t\t\t\t\t'name': 'Serax Deep Plate Merci No 8 9,8 cm',
\t\t\t\t\t\t\t\t'url':'/en_eur/productpage.0671850004.html',
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t'imageUrl':'set=source[02_0671850_004_3],type[PRODUCT],ImageVersion[201906121504]&call=url[file:/product/dynamic.chain]',
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t'price': '€7',
\t\t\t\t\t\t\t\t\t\t'priceOriginal': false,
\t\t\t\t\t\t\t\t\t\t'priceValue': '7.0',
...
\t\t\t\t\t\t
\t\t\t\t\t\t{
\t\t\t\t\t\t\t'thumbnail': '//lp.arket.com/app006prod?set=source[02_0775166_002_1],type[PRODUCT],device[hdpi],quality[80],ImageVersion[201907291654]&call=url[file:/product/style]',
\t\t\t\t\t\t\t'image': 'set=source[02_0775166_002_1],type[PRODUCT],ImageVersion[201907291654]&call=url[file:/product/dynamic.chain]',
\t\t\t\t\t\t\t'fullscreen': 'set=source[02_0775166_002_1],type[PRODUCT],ImageVersion[201907291654]&call=url[file:/product/dynamic.chain]',
\t\t\t\t\t\t\t'zoom': 'set=source[02_0775166_002_1],type[PRODUCT],ImageVersion[201907291654]&call=url[file:/product/dynamic.chain]&zoom=zoom'
\t\t\t\t\t\t}
\t\t\t\t],
\t\t\t\t'detailImages' : [
\t\t\t\t\t\t
...
\t\t\t\t\t'link': '',
\t\t\t\t\t'text': '',
\t\t\t\t\t'supplier': 'Cerutil - Ceramicas Utilitarias',
\t\t\t\t\t'image': {
...
\t\t\t\t
\t\t\t\t
\t\t\t\t'url': '\\/en_eur\\/productpage.0775166002.html'
    \t\t} ,
\t\t\t'0775166001': {
\t\t\t\t'title': 'Glazed Plate 19 cm',
\t\t\t\t'name': 'Black',
...
\t\t\t\t'brandName': "",
\t\t\t\t'colorLoc': "Black",
\t\t\t\t'pdpLink' : 'https:\\/\\/www.arket.com\\/en_eur\\/homeware\\/kitchen\\/product.glazed-plate-19-cm-black.0775166001.html',
\t\t\t\t'originCountry': "Portugal",
\t\t\t\t
\t\t\t\t\t'styleWithArticles' : [
\t\t\t\t\t\t
\t\t\t\t\t\t\t{
\t\t\t\t\t\t\t\t'code':'0741443001',
\t\t\t\t\t\t\t\t'name': 'Serving Plate 26 cm',
\t\t\t\t\t\t\t\t'url':'/en_eur/productpage.0741443001.html',
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t'imageUrl':'set=source[02_0741443_001_001],type[PRODUCT],ImageVersion[2019091]&call=url[file:/product/dynamic.chain]',
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t'price': '€15',
\t\t\t\t\t\t\t\t\t\t'priceOriginal': false,
\t\t\t\t\t\t\t\t\t\t'priceValue': '15.0',
\t\t\t\t\t\t\t\t\t\t'priceSaleValue': null,
\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t'colorName':'Matte Textured Black'
\t\t\t\t\t\t\t},
\t\t\t\t\t\t\t{
\t\t\t\t\t\t\t\t'code':'0486087014',
\t\t\t\t\t\t\t\t'name': 'Bowl 17 cm',
\t\t\t\t\t\t\t\t'url':'/en_eur/productpage.0486087014.html',
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t'imageUrl':'set=source[02_0486087_014_001],type[PRODUCT],ImageVersion[2019091]&call=url[file:/product/dynamic.chain]',
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t'price': '€12',
\t\t\t\t\t\t\t\t\t\t'priceOriginal': false,
\t\t\t\t\t\t\t\t\t\t'priceValue': '12.0',
...
\t\t\t\t\t\t\t{
\t\t\t\t\t\t\t\t'code':'0486046002',
\t\t\t\t\t\t\t\t'name': 'Spouted Bowl 15 cm',
\t\t\t\t\t\t\t\t'url':'/en_eur/productpage.0486046002.html',
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t'imageUrl':'set=source[02_0486046_002_001],type[PRODUCT],ImageVersion[2018082]&call=url[file:/product/dynamic.chain]',
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t'price': '€25',
\t\t\t\t\t\t\t\t\t\t'priceOriginal': false,
\t\t\t\t\t\t\t\t\t\t'priceValue': '25.0',
...
\t\t\t\t\t\t\t\t'code':'0486127007',
\t\t\t\t\t\t\t\t'name': 'Large Creamer',
\t\t\t\t\t\t\t\t'url':'/en_eur/productpage.0486127007.html',
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t'imageUrl':'set=source[02_0486127_007_001],type[PRODUCT],ImageVersion[2019091]&call=url[file:/product/dynamic.chain]',
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t'price': '€12',
\t\t\t\t\t\t\t\t\t\t'priceOriginal': false,
\t\t\t\t\t\t\t\t\t\t'priceValue': '12.0',
...
\t\t\t\t\t\t
\t\t\t\t\t\t{
\t\t\t\t\t\t\t'thumbnail': '//lp.arket.com/app006prod?set=source[02_0775166_001_1],type[PRODUCT],device[hdpi],quality[80],ImageVersion[201907291654]&call=url[file:/product/style]',
\t\t\t\t\t\t\t'image': 'set=source[02_0775166_001_1],type[PRODUCT],ImageVersion[201907291654]&call=url[file:/product/dynamic.chain]',
\t\t\t\t\t\t\t'fullscreen': 'set=source[02_0775166_001_1],type[PRODUCT],ImageVersion[201907291654]&call=url[file:/product/dynamic.chain]',
\t\t\t\t\t\t\t'zoom': 'set=source[02_0775166_001_1],type[PRODUCT],ImageVersion[201907291654]&call=url[file:/product/dynamic.chain]&zoom=zoom'
\t\t\t\t\t\t}
\t\t\t\t],
\t\t\t\t'detailImages' : [
\t\t\t\t\t\t
...
\t\t\t\t
\t\t\t\t
\t\t\t\t'url': '\\/en_eur\\/productpage.0775166001.html'
    \t\t}
    };
...
\t\t\t\t\t\t\t            \t\t<img alt="Front image of Arket glazed plate 19 cm in beige" class="a-image is-hidden Resolve" src="//lp2.hm.com/hmgoepprod?blank=width[2],height[3],color[none]&sink=format[gif]" data-resolvewidth="2" data-resolveheight="3" data-resolvechain="set=source[02_0775166_002_1],type[PRODUCT],ImageVersion[201907291654]&call=url[file:/product/dynamic.chain]" data-large-src="set=source[02_0775166_002_1],type[PRODUCT],ImageVersion[201907291654]&call=url[file:/product/dynamic.chain]" data-thumbnail-src="set=source[02_0775166_002_1],type[PRODUCT],ImageVersion[201907291654]&call=url[file:/product/dynamic.chain]" data-zoom-src="set=source[02_0775166_002_1],type[PRODUCT],ImageVersion[201907291654]&call=url[file:/product/dynamic.chain]"/>
\t\t\t\t\t\t\t            \t</div>
\t\t\t\t\t\t            \t</div>
...
\t\t\t\t<span class="productCategory">com.accenture.hm.aem.integration.product.ProductCategory@7f911ccc</span>
\t\t\t\t<span class="price">8.0</span>
\t\t\t\t<span class="originalPrice">8.0</span>
\t\t\t\t<span class="articleCode">0775166002</span>
\t\t\t\t<span class="brandName">[]</span>
\t\t\t\t<span class="productName">Glazed Plate 19 cm</span>
\t\t\t\t<span class="colorName">White/Brown</span>
\t\t\t\t<span class="colorLoc">White/Brown</span>
    ...
    \t\t</div>
        <div class="product-name-price-wrapper">
            <h1 class="a-heading-3">
                <span id="productTitle">Glazed Plate 19 cm</span>
            </h1>
            <div class="m-product-price" id="product-price">
                <span id="productPrice" class="is-regular">€8</span>
\t</div>
        </div>
        <input type="hidden" class="uniqueSize" value="0775166002001" data-name="NOSIZE">
                        ...
                        \t<div class="accordion-inner-content">
                            <div data-component="MSwatches" class="m-swatches swatch-panel-container with-animation">
                                <div class="a-link-swatch selected">
                                    <a href="https://www.arket.com/en_eur/homeware/kitchen/product.glazed-plate-19-cm-beige.0775166002.html" target="_self" class="a-link">
                                        <img class="a-image" src="/medias/722-Terracotta.png?context=cDExfHJvb3R8NTA2MjB8aW1hZ2UvcG5nfGhhZS9oZTIvODgxNzc4Njc4MTcyNi5wbmd8YTZkMTk3ZmUwNmY4YTEzZTE4ZTRkNjRmYmIyODE1MmM4MzY1NTQzN2FkZmVkMGEwMjFiNDBmOGUwNWE5Y2UwMA&storeId=p11-europe" alt="Terracotta">
                                        <span class="a-swatch-title">Terracotta</span>
                                    </a>
                                </div>
                                </div>
                            </div>
                    ...
                    <div class="accordion-header">
                        <a href="#" target="_self" class="a-link accordion-title js-accordion-toggle">
                            <span class="pdp-label i18n">Color</span>
                                    <span id="colorArticleValue" class="pdp-value">White/Brown</span>
                                </a>
                    </div>
                    <div class="accordion-content">
                        <div id="MSwatches" data-component="MSwatches" class="m-swatches color-panel-container with-animation">
                            <div data-id="swatchP_0775166002" id="swatchP_0775166002" class="a-swatch js-swatch is-selected">
\t                                <input type="radio">
\t                                <button id="swatchButton" type="button" class="a-button-nostyle">
\t                                \t<span class="a-swatch-foreground"></span>
                                        <img data-id="swatchImg_0775166002" class="a-image" data-articlecode="0775166002" src="//lp.arket.com/app006prod?set=source[04_0775166_002_1],type[FABRICSWATCH],device[],quality[80],ImageVersion[201907291657]&call=url[file:/product/main]" alt="Fabric Swatch image of Arket glazed plate 19 cm in beige">
                                        <span class="sold-out i18n">Sold out</span>
                                    </button>
                                    <p class="a-paragraph swatch-title">White/Brown</p>
                                        <p class="a-paragraph sold-out-swatch">OUT OF STOCK</p></div>
                            <div data-id="swatchP_0775166001" id="swatchP_0775166001" class="a-swatch js-swatch  is-sold-out">
\t                                <input type="radio">
\t                                <button id="swatchButton" type="button" class="a-button-nostyle">
\t                                \t<span class="a-swatch-foreground"></span>
                                        <img data-id="swatchImg_0775166001" class="a-image" data-articlecode="0775166001" src="//lp.arket.com/app006prod?set=source[04_0775166_001_1],type[FABRICSWATCH],device[],quality[80],ImageVersion[201907291657]&call=url[file:/product/main]" alt="Fabric Swatch image of Arket glazed plate 19 cm in black">
                                        <span class="sold-out i18n">Sold out</span>
                                    </button>
            ...
            <div class="made-in-el" id="made-in">
                <div data-component="OAccordion" class="o-accordion pdp align-left full-width" data-exclusive="true" data-exclusive-group="pdpPage">
                    <div class="accordion-header">
                        <a href="#" target="_self" class="a-link accordion-title js-accordion-toggle">
                            <span class="pdp-value" id="made-in-title i18n">Made in Portugal</span>
                        </a>
                    </div>
                    <div class="accordion-content">
                    <div class="accordion-inner-content">
                        <div class="m-made-in">
                        \t<img class="a-image" src="/medias/Portugal.png?context=cDExfGltYWdlc3w5OTczMHxpbWFnZS9wbmd8aW1hZ2VzL2g4Yy9oNmQvODgwMzc2NDYzMzYzMC5wbmd8NjlmZjU3ZjFlNTRmYWI3YjFhMTdlOTA0MWYwMDJkNTU5ZTI3NjdlYzI4MmFlZDc1YTBhZTZhNTVkYWZhYjFjYQ&storeId=p11-europe" id="made-in-image">
    \t\t\t\t\t\t<div class="made-in-content made-in" id="made-in-content">
        \t\t\t\t\t\t<span class="pdp-label i18n">Made in</span>
        \t\t\t\t\t\t<div class="made-in-value">
           \t\t \t\t\t\t\t<span id="made-in-region-name">Portugal</span>
           \t\t \t\t\t\t\t</div>
    \t\t\t\t\t\t</div>
    \t\t\t\t\t\t<div class="made-in-content supplier" id="made-in-supplier">
        \t\t\t\t\t\t\t<span class="pdp-label i18n">Supplier</span>
        \t\t\t\t\t\t\t<div class="made-in-value">
            \t\t\t\t\t\t\t<span>Cerutil - Ceramicas Utilitarias</span>
        \t\t\t\t\t\t\t</div>
    \t\t\t\t\t\t\t</div>
...
<div class="right-panel"><div class="swatch-container color-swatch-container">
   <div data-component="MSwatches" class="m-swatches swatch-panel-container colors"><h4 class="a-heading-4 i18n">Colors</h4><div data-id="swatch_0775166002" id="swatch_0775166002" class="a-swatch js-swatch is-selected"><label id="swatchLabel" class="a-label js-a-label"><input type="radio"><span><div class="a-swatch-foreground"></div><img class="a-image" data-articlecode="0775166002" src="//lp.arket.com/app006prod?set=source[04_0775166_002_1],type[FABRICSWATCH],device[],quality[80],ImageVersion[201907291657]&call=url[file:/product/main]" alt="Fabric Swatch image of Arket glazed plate 19 cm in beige" onclick="trackProductVariant(this);"><p class="sold-out i18n">Sold out</p><p class="a-paragraph swatch-title" data-articlecode="0775166002">White/Brown</p></span></label><p class="a-paragraph sold-out-swatch">OUT OF STOCK</p></div><div data-id="swatch_0775166001" id="swatch_0775166001" class="a-swatch js-swatch  is-sold-out"><label id="swatchLabel" class="a-label js-a-label"><input type="radio"><span><div class="a-swatch-foreground"></div><img class="a-image" data-articlecode="0775166001" src="//lp.arket.com/app006prod?set=source[04_0775166_001_1],type[FABRICSWATCH],device[],quality[80],ImageVersion[201907291657]&call=url[file:/product/main]" alt="Fabric Swatch image of Arket glazed plate 19 cm in black" onclick="trackProductVariant(this);"><p class="sold-out i18n">Sold out</p><p class="a-paragraph swatch-title" data-articlecode="0775166001">Black</p></span></label><p class="a-paragraph sold-out-swatch">OUT OF STOCK</p></div></div>
   </div>
                ...
                <h4 class="a-heading-4 i18n">Materials</h4>
                    <div class="a-link-swatch selected">
                        <a target="_self" class="a-link">
                            <img class="a-image" src="/medias/722-Terracotta.png?context=cDExfHJvb3R8NTA2MjB8aW1hZ2UvcG5nfGhhZS9oZTIvODgxNzc4Njc4MTcyNi5wbmd8YTZkMTk3ZmUwNmY4YTEzZTE4ZTRkNjRmYmIyODE1MmM4MzY1NTQzN2FkZmVkMGEwMjFiNDBmOGUwNWE5Y2UwMA&storeId=p11-europe">
                            <span class="a-swatch-title">Terracotta</span>
                        </a>
                    </div>
                </div>
...
\t\t\t<div data-apptusvalue="homeware_kitchen_all"></div>
\t<div data-type="product" data-code="570307-720" data-icon="//lp.arket.com/app006prod?set=source[02_0775166_002_1],type[PRODUCT],device[hdpi],quality[80],ImageVersion[201907291654]&call=url[file:/product/main]" data-title="Glazed Plate 19 cm"></div>
</div>
...
\t<div id="osliderStyleWith" class="o-width wc-75 carousel">
        <span class="nodeName" hidden></span>
        <span class="propTitle" hidden>Style with</span>
        <div class="o-pra-component is-combine-with">
            <h2 class="a-heading-2 u-align-center is-main-heading">Style with</h2>
            <div data-component="OSlider" class="o-slider" data-pagination="false" data-multislide="true" data-num-slides="adaptive" data-slide-width="200">
                <div class="redils">
                    <div class="slide-cont" id="sliderStyleWith">
                        <div class="slides">
                                <div class="o-product" onclick="trackProductClick(this,'.o-product')">
                                    <a href="https://www.arket.com/en_eur/homeware/kitchen/product.serax-plate-merci-no-3,-medium14-cm-beige.0671713003.html" target="_self" class="a-link" onclick="setVCParameter('STYLE_WITH','0671713003');">
                                        <div class="image">
                                        \t<div class="m-product-image">
                                        \t\t<div class="cross"></div>
                                        \t\t<div class="placeholder-wrapper">
\t\t                                        \t\t\t<img src="//lp2.hm.com/hmgoepprod?blank=width[2],height[3],color[none]&sink=format[gif]" data-resolvewidth="2" data-resolveheight="3" data-resolvechain="set=source[02_0671713_003_1],type[PRODUCT],ImageVersion[201908051103]&call=url[file:/product/dynamic.chain]" alt="Front image of Arket serax plate merci no 3, medium14 cm in beige" class="product-image is-hidden Resolve"/>
\t\t                                        \t\t</div>
                                            \t\t</div>
                                        </div>
                                        <div class="description">
                                            ...
                                            <div class="product">
                                                <span class="i18n">Product</span>
                                                <span>Serax Plate Merci No 3, Medium14 cm</span>
                                            </div>
                                            <div class="price">
                                                <span class="i18n">Price</span>
                                                <div class="m-product-price">
                                                    <span id="price" class="is-regular price-value" >€10</span>
\t\t
\t</div>
                                            </div>
                                        </div>
...
\t\t\t\t\t\t\t\t\t\t<div class="producttile-details" hidden>
\t\t\t\t\t\t\t\t\t\t\t<span class="articleCode">0671713003</span>
\t\t\t\t\t\t\t\t\t\t\t<span class="baseProductCode"></span>
\t\t\t\t\t\t\t\t\t\t\t<span class="productName">Serax Plate Merci No 3, Medium14 cm</span>
\t\t\t\t\t\t\t\t\t\t\t<span class="productCategory">Kitchen - homeware_kitchen_all</span>
...
\t\t\t\t\t\t\t\t\t\t</div>
                        ...
                        <div class="slides">
                                <div class="o-product" onclick="trackProductClick(this,'.o-product')">
                                    <a href="https://www.arket.com/en_eur/homeware/kitchen/product.serax-deep-plate-merci-no-8-9,8-cm-beige.0671850004.html" target="_self" class="a-link" onclick="setVCParameter('STYLE_WITH','0671850004');">
                                        <div class="image">
                                        \t<div class="m-product-image">
                                        \t\t<div class="cross"></div>
                                        \t\t<div class="placeholder-wrapper">
\t\t                                        \t\t\t<img src="//lp2.hm.com/hmgoepprod?blank=width[2],height[3],color[none]&sink=format[gif]" data-resolvewidth="2" data-resolveheight="3" data-resolvechain="set=source[02_0671850_004_3],type[PRODUCT],ImageVersion[201906121504]&call=url[file:/product/dynamic.chain]" alt="Front image of Arket serax deep plate merci no 8 9,8 cm in beige" class="product-image is-hidden Resolve"/>
\t\t                                        \t\t</div>
                                            \t\t</div>
                                        </div>
                                        <div class="description">
                                            ...
                                            <div class="product">
                                                <span class="i18n">Product</span>
                                                <span>Serax Deep Plate Merci No 8 9,8 cm</span>
                                            </div>
                                            <div class="price">
                                                <span class="i18n">Price</span>
                                                <div class="m-product-price">
                                                    <div class="price parbase"><span id="price" class="is-regular price-value" >€7</span>
\t\t
\t</div>
</div>
                                            </div>
                                        ...
                                        <!-- product styleWith details -->
\t\t\t\t\t\t\t\t\t\t<div class="producttile-details" hidden>
\t\t\t\t\t\t\t\t\t\t\t<span class="articleCode">0671850004</span>
\t\t\t\t\t\t\t\t\t\t\t<span class="baseProductCode"></span>
\t\t\t\t\t\t\t\t\t\t\t<span class="productName">Serax Deep Plate Merci No 8 9,8 cm</span>
\t\t\t\t\t\t\t\t\t\t\t<span class="productCategory">Kitchen - homeware_kitchen_all</span>
\t\t\t\t\t\t\t\t\t\t\t<span class="currencyCode"></span>
\t\t\t\t\t\t\t\t\t\t\t<span class="price">7.0</span>
\t\t\t\t\t\t\t\t\t\t\t<span class="originalPrice">7.0</span>
\t\t\t\t\t\t\t\t\t\t\t<span class="colorName">Brown</span>
\t\t\t\t\t\t\t\t\t\t\t<span class="brandName">[]</span>
\t\t\t\t\t\t\t\t\t\t\t<span class="colorLoc"></span>
\t\t\t\t\t\t\t\t\t\t\t<span class="atelierName"></span>
...
<div data-variant-number-reached="maxVariantNumberReached" data-order-lines-reached="maxOrderLinesReached" data-product-code-quick-buy="" data-component="OQuickBuy" class="o-quick-buy is-one-size">
    <form data-component="OForm" class="o-form add-to-cart" action="/someURL" method="POST" onsubmit="p11App.quickBuy.trackQBAddToCart('en_eur', '0775166002', this)">
    ...
    <div class="m-product-image">
        \t\t\t<div class="cross"></div>
        \t\t\t<div class="placeholder-wrapper">
        \t\t\t\t\t\t<img src="//lp2.hm.com/hmgoepprod?blank=width[2],height[3],color[none]&sink=format[gif]" data-resolvewidth="2" data-resolveheight="3" data-resolvechain="set=source[02_0775166_002_1],type[PRODUCT],ImageVersion[201907291654]&call=url[file:/product/dynamic.chain]" alt="Front image of Arket glazed plate 19 cm in beige" class="Resolve is-hidden quickshopImage">
        \t\t\t\t\t</div>
        \t\t\t\t</div>
        \t<div class="m-product-price" id="product-quickbuy">
            <span class="product-name u-ellipsis" id="productTitle"> Glazed Plate 19 cm</span>
            <span class="price" id="product-price-quickbuy">€8</span>
        </div>
        <input type="hidden" class="uniqueSize" value="0775166002001" data-name="NOSIZE">
...
<script>
            ...
            \tvar currencyFromCookie = hm.multiCountry.readCookieValue('HMCORP_currency');
                ...
                if (hm.multiCountry && !requestFromWebCrawler) {
                    ...
                    \tvar georguriURL = '?goeorguri=%2Fen_eur%2Fhomeware%2Fkitchen%2Fproduct.glazed-plate-19-cm-beige.0775166002.html';
                    \tvar redirectPageURL = "";
...
<div id="productBodyLibs" data-add-to-cart-service-url="/en_eur/cart/add" data-article-code="0775166002" data-product="com.hm.appeaser.aem.integration.product.AppProduct@7a40b40d" hidden></div></div>
