...
export class ProductsController {
  ...
  @Get('/')
  @ApiOperation({ summary: 'List of products', description: 'Get the products for the logged in user' })
  ...
  @Post('/init')
  @ApiOperation({ summary: 'Initialize product', description: 'Parse the product data for the given url without saving it in the database.' })
  @ApiCreatedResponse({
    description: 'Returns the initial data for a product. Not yet saved in the database.',
    type: ProductInitResponse,
  })
  initProduct(@Body() initProductDto: InitializeProductDto): Promise<ProductInitResponse> {
    return this.productsService.initializeProduct(initProductDto.url);
  }

  @Post('/')
  @ApiOperation({ summary: 'Save product', description: 'Saves a new product to the database with the chosen size.' })
  ...
  @Post('/:id/markread')
  @ApiOperation({ summary: 'Mark updates as read', description: 'If the product has unread updates they will be marked as read.' })
  ...
  @Post('/:id/update')
  @ApiOperation({ summary: 'Update single product', description: 'Gets the product updates for the given single product.' })
  @ApiCreatedResponse({ description: 'Returns the updated product.' })
  @ApiParam({ name: 'id', type: String })
  ...
  @Delete('/:id')
  @ApiOperation({ summary: 'Delete product', description: 'Deletes the given product.' })
