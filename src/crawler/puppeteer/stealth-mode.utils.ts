 ...
 * Taken from https://github.com/apify/apify-js
 */
...
const hideWebDriver = () => {
  Object.defineProperty(window, 'navigator', {
    value: new Proxy(navigator, {
      ...
      get: (target, key) =>
        key === 'webdriver' // eslint-disable-line
          ? undefined
          : key === 'connection'
          ? undefined
...
export const enableStealthMode = (page: puppeteer.Page) => {
