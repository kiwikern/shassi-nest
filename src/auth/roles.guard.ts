...
export class RolesGuard implements CanActivate {
  ...
  canActivate(context: ExecutionContext): boolean {
    const requiredMethodRoles = this.reflector.get<string[]>(METADATA_KEY_ROLES, context.getHandler()) || [];
    const requiredClassRoles = this.reflector.get<string[]>(METADATA_KEY_ROLES, context.getClass()) || [];
